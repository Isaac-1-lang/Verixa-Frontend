...
export const trainingApi = apiSlice.injectEndpoints({
 endpoints: builder => ({
  ...
  updateTrainingSession: builder.mutation({ query:({id,...body})=>({url:training(`/sessions/${id}`),method:'PUT',body}), invalidatesTags:['Training'] }),
...
export const { useGetMeQuery,useGetTrainingOverviewQuery,useGetTrainingProgramsQuery,useGetTrainingProgramQuery,useCreateTrainingProgramMutation,useUpdateTrainingProgramMutation,useArchiveTrainingProgramMutation,useGetTrainingParticipantsQuery,useGetTrainingParticipantQuery,useCreateTrainingParticipantMutation,useGetTrainingGroupsQuery,useCreateTrainingGroupMutation,useGetProgramModulesQuery,useCreateProgramModuleMutation,useGetProgramMembersQuery,useAddProgramMemberMutation,useBulkAddProgramMembersMutation,useGetTrainingSessionsQuery,useGetTrainingSessionQuery,useCreateTrainingSessionMutation,useUpdateTrainingSessionMutation,useCreateFollowUpSessionMutation,useAssignSessionParticipantsMutation,useRecordSessionAttendanceMutation,useRecordModuleCompletionMutation,useGetProgramAssessmentsQuery,useCreateTrainingAssessmentMutation,useGetProgramIssuesQuery,useCreateTrainingIssueMutation,useUpdateTrainingIssueMutation,useGetProgramFeedbackQuery,useCreateTrainingFeedbackMutation,useGetProgramReadinessQuery,useGetProgramNeedsAttentionQuery,useGetProgramTrainingReportQuery } = trainingApi;
